...
public class Veritabani extends SQLiteOpenHelper {
    private static String DB_PATH= "data/data/com.example.rmznshn.rssokuyucu/databases/";
    private static String DB_NAME = "haberler";
    ...
    private boolean checkDB(){
        ...
        try{
            ...
            if (checkDB!=null)
            {
                Cursor c= checkDB.rawQuery("SELECT * FROM haberler", null);
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE haberler (id INTEGER PRIMARY KEY AUTOINCREMENT,name TEXT,url TEXT);");
    }

    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("DROP TABLE If EXIST haberler");
        onCreate(db);
    }
}